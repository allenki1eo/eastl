...
export default function BeerScrollFilter() {
  const [currentIndex, setCurrentIndex] = useState<number>(-1);

  const nextSlide = useCallback(() => {
    const nextIndex = currentIndex === -1 ? 0 : (currentIndex + 1) % beers.length;
  ...
  const previousSlide = useCallback(() => {
    const prevIndex =
      currentIndex === -1
        ? beers.length - 1
        : (currentIndex - 1 + beers.length) % beers.length;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="font-semibold">{beer.specs.type}</span>
                </div>
                <div
                ...
                >
                  ...
                  <span className="font-semibold">{beer.specs.abv}</span>
                </div>
                <div
                  className={`flex justify-between mb-1.5 text-sm transition-all duration-400 ease-[cubic-bezier(0.4,0,0.2,1)] ${currentIndex === index
                ...
                >
                  ...
                  <span className="font-semibold">{beer.specs.volume}</span>
                </div>
              </div>
